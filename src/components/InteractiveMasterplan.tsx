  ...
  const markers = [
    {
      ...
      code: '01 ARRIVAL',
      title: '01 — ARRIVAL',
      desc: 'Grand gated entrance and landscaped boulevard.',
      shortDesc: 'Grand gated entrance & boulevard.',
      x: 16, // percentage X on masterplan board
      y: 72, // percentage Y on masterplan board
    },
    {
      id: 1,
      num: '02',
      ...
      shortDesc: 'Thoughtfully arranged villa clusters.',
      x: 42,
      y: 34,
    },
    {
      ...
      shortDesc: '15,000 sq.ft community & wellness.',
      x: 74,
      y: 44,
    },
    {
      ...
      desc: '70% open green environment with gardens and community spaces.',
      shortDesc: '70% open green environment.',
      x: 58,
      y: 74,
    },
    {
      ...
      code: '05 WALKWAYS',
      title: '05 — WALKWAYS',
      desc: 'Connected pedestrian paths through gardens and open spaces.',
      shortDesc: 'Connected pedestrian paths.',
      x: 25,
      y: 24,
    },
  ];
  ...
  return (
    <section id="masterplan" className="w-full bg-white py-6 md:py-8 text-[#0F172A] relative overflow-hidden border-t border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4">
        ...
        {/* TOP COMPACT HEADER                                                */}
        {/* ================================================================= */}
        <div className="max-w-3xl pb-2 border-b border-slate-200/80">
          <motion.div 
          ...
          <motion.h2 
            ...
            className="text-2xl sm:text-3xl lg:text-[32px] font-extrabold uppercase leading-[1.15] tracking-tight mb-1"
          >
        ...
        {/* ================================================================= */}
        {/* MAIN CONTENT (DESKTOP: 78% MASTERPLAN BOARD + 22% NARROW GUIDE)   */}
        {/* ================================================================= */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
          
          {/* LEFT COLUMN (Span 9 or ~78% width) — HERO ARCHITECTURAL MASTERPLAN */}
          <div className="lg:col-span-9 relative rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-slate-900 aspect-[16/10] sm:aspect-[16/9] lg:aspect-[16/9.5] group select-none flex flex-col justify-between p-4">
            
            {/* Top-Down Architectural Site Plan Visualization */}
            <img 
              src="/images/hero_main_aerial.png" 
              alt="Antelia Groves Architectural Masterplan Illustration" 
            ...
            <div className="relative z-10 flex items-center justify-between">
              <span className="bg-slate-950/80 backdrop-blur-md text-white text-[10px] font-extrabold uppercase px-3 py-1 rounded-full border border-white/20">
                10-ACRE ARCHITECTURAL MASTERPLAN PRESENTATION
              </span>
            ...
            {/* SVG SUBTLE DASHED CONNECTOR ROUTE LINE */}
            ...
            {/* 5 ELEGANT NUMBERED MARKERS DIRECTLY ON MASTERPLAN */}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="truncate">{item.code.replace(/^\d+\s*/, '')}</span>
                  </button>

                  {/* SMALL CONNECTED INFORMATION PANEL (BESIDE SELECTED AREA) */}
                  <AnimatePresence>
                    {isActive && (
                      <motion.div
                        ...
                        className={`absolute z-40 w-52 bg-white rounded-xl p-3 border border-slate-200 shadow-xl text-left pointer-events-auto ${
            ...
            {/* Bottom Left Active Zone Caption */}
            <div className="relative z-10 bg-slate-950/85 backdrop-blur-md px-3.5 py-1.5 rounded-xl border border-white/15 text-white max-w-sm flex items-center justify-between">
              <div>
          ...
          {/* RIGHT COLUMN (Span 3 or ~22% width) — NARROW MASTERPLAN GUIDE */}
          <div className="lg:col-span-3 bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-2">
            ...
            {/* 5 COMPACT NUMBERED ROWS */}
            <div className="space-y-2">
              {markers.map((item, idx) => {
                const isSelected = activeMarkerIndex === idx;
                ...
                return (
                  <div
                    ...
                    className={`p-2.5 rounded-xl border transition-all duration-300 cursor-pointer ${
                      isSelected 
                        ? 'bg-white border-[#F97316] shadow-2xs ring-1 ring-[#F97316]' 
        ...
        {/* MOBILE HORIZONTAL HOTSPOT SELECTOR (VISIBLE ON MOBILE & TABLET) */}
        <div className="flex lg:hidden items-center gap-1.5 overflow-x-auto no-scrollbar py-1">
          {markers.map((m, idx) => (
            ...
            >
              {m.num} {m.code.replace(/^\d+\s*/, '')}
            </button>
          ))}
        </div>

        {/* ================================================================= */}
        {/* BOTTOM DATA BAR (ONE CLEAN HORIZONTAL ROW)                       */}
        {/* ================================================================= */}
        <div className="w-full bg-slate-50/90 rounded-2xl p-3 sm:p-4 border border-slate-200/90 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 items-center gap-4 sm:gap-6 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-lg bg-orange-50 border border-orange-200/80 flex items-center justify-center text-[#F97316] shrink-0">
