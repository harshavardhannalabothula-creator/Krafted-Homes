...
export default function PastDeliveredProjectsSection({ onOpenBooking }: PastDeliveredProjectsSectionProps) {
  ...
  const pastProjects = [
    ...
    {
      id: 2,
      title: 'Stage 1 RCC Frame & Waterproofing',
      ...
      image: '/images/construction_stage_01_1789036228602.png',
      badge: 'Quality Milestone',
    },
    {
      id: 3,
      title: 'Keys Handover to Villa Buyer',
      category: 'handovers',
      year: 'Delivered 2025',
    ...
    {
      id: 4,
      title: 'Modern Daylight Villa Facade',
      category: 'villas',
      year: 'Delivered 2024',
    ...
    {
      id: 6,
      title: 'Happy Family Moving Into New Villa',
      category: 'handovers',
      year: 'Delivered 2025',
